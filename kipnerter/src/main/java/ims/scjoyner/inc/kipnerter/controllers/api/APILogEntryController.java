...
import ims.scjoyner.inc.kipnerter.controllers.api.comm.LogEntryRequestBody;
import ims.scjoyner.inc.kipnerter.controllers.api.comm.LogEntryTableRow;
import ims.scjoyner.inc.kipnerter.models.enums.Role;
import ims.scjoyner.inc.kipnerter.models.enums.TransactionType;
import ims.scjoyner.inc.kipnerter.models.persistent.LogEntry;
    ...
    public ResponseEntity getEntryByDateRange ( @RequestBody final LogEntryRequestBody body ) {
        ...
        if ( user.getRole() == Role.ROLE_CUSTOMER ) {
            ...
            for ( int i = 0; i < entries.size(); i++ ) {
                ...
                if ( !le.getLogCode().isAdminViewable() ) {
