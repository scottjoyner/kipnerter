...
import ims.scjoyner.inc.kipnerter.forms.personnel.PasswordChangeForm;
import ims.scjoyner.inc.kipnerter.models.enums.TransactionType;
import ims.scjoyner.inc.kipnerter.models.persistent.PasswordResetToken;
import ims.scjoyner.inc.kipnerter.models.persistent.Personnel;
import ims.scjoyner.inc.kipnerter.models.persistent.User;
import ims.scjoyner.inc.kipnerter.utils.EmailUtil;
    ...
    public ResponseEntity requestReset ( @RequestBody final String username ) {
        ...
        try {
            ...
            if ( person != null ) {
                ...
                throw new Exception( "Personnel on file for " + user.getId() );
            }
